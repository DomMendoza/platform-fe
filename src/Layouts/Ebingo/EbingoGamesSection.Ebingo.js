...
function EbingoGamesSection() {
  ...
  return (
    <div className=" flex flex-col gap-5 p-8 rounded-lg bg-gradient-to-b from-white via-blue-500 to-indigo-400 bg-opacity-50 text-gray-800 backdrop-blur-lg shadow-lg">
